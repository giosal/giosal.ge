jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    t.MixItUp = function () {
        ...
        addAction: function (e, i, s, n) {
            t.MixItUp.prototype._addHook("_actions", e, i, s, n)
        },
        addFilter: function (e, i, s, n) {
            t.MixItUp.prototype._addHook("_filters", e, i, s, n)
        },
        _addHook: function (e, i, s, n, o) {
            var r = t.MixItUp.prototype[e], a = {};
            o = 1 === o || "post" === o ? "post" : "pre", a[i] = {}, a[i][o] = {}, a[i][o][s] = n, t.extend(!0, r, a)
        },
        _init: function (e, i) {
            var s = this;
            if (s._execAction("_init", 0, arguments), i && t.extend(!0, s, i), s._$body = t("body"), s._domNode = e, s._$container = t(e), s._$container.addClass(s.layout.containerClass), s._id = e.id, s._platformDetect(), s._brake = s._getPrefixedCSS("transition", "none"), s._refresh(!0), s._$parent = s._$targets.parent().length ? s._$targets.parent() : s._$container, s.load.sort && (s._newSort = s._parseSort(s.load.sort), s._newSortString = s.load.sort, s._activeSort = s.load.sort, s._sort(), s._printSort()), s._activeFilter = "all" === s.load.filter ? s.selectors.target : "none" === s.load.filter ? "" : s.load.filter, s.controls.enable && s._bindHandlers(), s.controls.toggleFilterButtons) {
                s._buildToggleArray();
                for (var n = 0; n < s._toggleArray.length; n++) s._updateControls({
                    filter: s._toggleArray[n],
                    sort: s._activeSort
                }, !0)
            } else s.controls.enable && s._updateControls({filter: s._activeFilter, sort: s._activeSort});
            s._filter(), s._init = !0, s._$container.data("mixItUp", s), s._execAction("_init", 1, arguments), s._buildState(), s._$targets.css(s._brake), s._goMix(s.animation.enable)
        },
        _platformDetect: function () {
            var t = this, i = ["Webkit", "Moz", "O", "ms"], s = ["webkit", "moz"],
                n = window.navigator.appVersion.match(/Chrome\/(\d+)\./) || !1,
                o = "undefined" != typeof InstallTrigger, r = function (t) {
                    for (var e = 0; e < i.length; e++) if (i[e] + "Transition" in t.style) return {
                        prefix: "-" + i[e].toLowerCase() + "-",
                        vendor: i[e]
                    };
                    return "transition" in t.style ? "" : !1
                }, a = r(t._domNode);
            t._execAction("_platformDetect", 0), t._chrome = n ? parseInt(n[1], 10) : !1, t._ff = o ? parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]) : !1, t._prefix = a.prefix, t._vendor = a.vendor, t._suckMode = window.atob && t._prefix ? !1 : !0, t._suckMode && (t.animation.enable = !1), t._ff && t._ff <= 4 && (t.animation.enable = !1);
            for (var l = 0; l < s.length && !window.requestAnimationFrame; l++) window.requestAnimationFrame = window[s[l] + "RequestAnimationFrame"];
        ...
        _refresh: function (t, i) {
            var s = this;
            s._execAction("_refresh", 0, arguments), s._$targets = s._$container.find(s.selectors.target);
            for (var n = 0; n < s._$targets.length; n++) {
                var o = s._$targets[n];
                if (o.dataset === e || i) {
                    o.dataset = {};
                    for (var r = 0; r < o.attributes.length; r++) {
                        var a = o.attributes[r], l = a.name, h = a.value;
                        if (l.indexOf("data-") > -1) {
                            var c = s._helpers._camelCase(l.substring(5, l.length));
                            o.dataset[c] = h
                        }
                    }
                }
                o.mixParent === e && (o.mixParent = s._id)
            }
            if (s._$targets.length && t || !s._origOrder.length && s._$targets.length) {
                s._origOrder = [];
                for (var n = 0; n < s._$targets.length; n++) {
                    var o = s._$targets[n];
                    s._origOrder.push(o)
            ...
            s._execAction("_refresh", 1, arguments)
        },
        _bindHandlers: function () {
            var i = this, s = t.MixItUp.prototype._bound._filter, n = t.MixItUp.prototype._bound._sort;
            i._execAction("_bindHandlers", 0), i.controls.live ? i._$body.on("click.mixItUp." + i._id, i.selectors.sort, function () {
                ...
                i._processClick(t(this), "filter")
            })), s[i.selectors.filter] = s[i.selectors.filter] === e ? 1 : s[i.selectors.filter] + 1, n[i.selectors.sort] = n[i.selectors.sort] === e ? 1 : n[i.selectors.sort] + 1, i._execAction("_bindHandlers", 1)
        },
        _processClick: function (i, s) {
            var n = this, o = function (i, s, o) {
                var r = t.MixItUp.prototype;
                r._handled["_" + s][n.selectors[s]] = r._handled["_" + s][n.selectors[s]] === e ? 1 : r._handled["_" + s][n.selectors[s]] + 1, r._handled["_" + s][n.selectors[s]] === r._bound["_" + s][n.selectors[s]] && (i[(o ? "remove" : "add") + "Class"](n.controls.activeClass), delete r._handled["_" + s][n.selectors[s]])
            };
            if (n._execAction("_processClick", 0, arguments), !n._mixing || n.animation.queue && n._queue.length < n.animation.queueLimit) {
                if (n._clicking = !0, "sort" === s) {
                    var r = i.attr("data-sort");
                    (!i.hasClass(n.controls.activeClass) || r.indexOf("random") > -1) && (t(n.selectors.sort).removeClass(n.controls.activeClass), o(i, s), n.sort(r))
                }
                if ("filter" === s) {
                    var a, l = i.attr("data-filter"), h = "or" === n.controls.toggleLogic ? "," : "";
                    n.controls.toggleFilterButtons ? (n._buildToggleArray(), i.hasClass(n.controls.activeClass) ? (o(i, s, !0), a = n._toggleArray.indexOf(l), n._toggleArray.splice(a, 1)) : (o(i, s), n._toggleArray.push(l)), n._toggleArray = t.grep(n._toggleArray, function (t) {
                        return t
                    }), n._toggleString = n._toggleArray.join(h), n.filter(n._toggleString)) : i.hasClass(n.controls.activeClass) || (t(n.selectors.filter).removeClass(n.controls.activeClass), o(i, s), n.filter(l))
                }
        ...
        _buildToggleArray: function () {
            ...
            if (t._execAction("_buildToggleArray", 0, arguments), "or" === t.controls.toggleLogic) t._toggleArray = e.split(","); else {
                ...
                for (var i, s = 0; i = t._toggleArray[s]; s++) t._toggleArray[s] = "." + i
            }
            t._execAction("_buildToggleArray", 1, arguments)
        },
        _updateControls: function (i, s) {
            var n = this, o = {filter: i.filter, sort: i.sort}, r = function (t, e) {
                try {
                    s && "filter" === a && "none" !== o.filter && "" !== o.filter ? t.filter(e).addClass(n.controls.activeClass) : t.removeClass(n.controls.activeClass).filter(e).addClass(n.controls.activeClass)
                } catch (i) {
                }
            }, a = "filter", l = null;
            n._execAction("_updateControls", 0, arguments), i.filter === e && (o.filter = n._activeFilter), i.sort === e && (o.sort = n._activeSort), o.filter === n.selectors.target && (o.filter = "all");
            for (var h = 0; 2 > h; h++) l = n.controls.live ? t(n.selectors[a]) : n["_$" + a + "Buttons"], l && r(l, "[data-" + a + '="' + o[a] + '"]'), a = "sort";
        ...
        _filter: function () {
            ...
            for (var i = 0; i < e._$targets.length; i++) {
                var s = t(e._$targets[i]);
                s.is(e._activeFilter) ? e._$show = e._$show.add(s) : e._$hide = e._$hide.add(s)
            }
        ...
        _sort: function () {
            var t = this, e = function (t) {
                for (var e = t.slice(), i = e.length, s = i; s--;) {
                    var n = parseInt(Math.random() * i), o = e[s];
                    e[s] = e[n], e[n] = o
                }
                return e
            };
        ...
        _compare: function (t, e, i) {
            i = i ? i : 0;
            var s = this, n = s._newSort[i].order, o = function (t) {
                return t.dataset[s._newSort[i].sortBy] || 0
            }, r = isNaN(1 * o(t)) ? o(t).toLowerCase() : 1 * o(t), a = isNaN(1 * o(e)) ? o(e).toLowerCase() : 1 * o(e);
            return a > r ? "asc" === n ? -1 : 1 : r > a ? "asc" === n ? 1 : -1 : r === a && s._newSort.length > i + 1 ? s._compare(t, e, i + 1) : 0
        },
        _printSort: function (t) {
            var e = this, i = t ? e._startOrder : e._newOrder, s = e._$parent[0].querySelectorAll(e.selectors.target),
                n = s.length ? s[s.length - 1].nextElementSibling : null, o = document.createDocumentFragment();
            e._execAction("_printSort", 0, arguments);
            for (var r = 0; r < s.length; r++) {
                var a = s[r], l = a.nextSibling;
            ...
            n ? e._$parent[0].insertBefore(o, n) : e._$parent[0].appendChild(o), e._execAction("_printSort", 1, arguments)
        },
        _parseSort: function (t) {
            for (var e = this, i = "string" == typeof t ? t.split(" ") : [t], s = [], n = 0; n < i.length; n++) {
                var o = "string" == typeof t ? i[n].split(":") : ["custom", i[n]],
                    r = {sortBy: e._helpers._camelCase(o[0]), order: o[1] || "asc"};
                if (s.push(r), "default" === r.sortBy || "random" === r.sortBy) break
            }
            return e._execFilter("_parseSort", s, arguments)
        },
        _parseEffects: function () {
            var t = this, e = {opacity: "", transformIn: "", transformOut: "", filter: ""}, i = function (e, i, s) {
                if (t.animation.effects.indexOf(e) > -1) {
                    if (i) {
                        var n = t.animation.effects.indexOf(e + "(");
                        if (n > -1) {
                            var o = t.animation.effects.substring(n), r = /\(([^)]+)\)/.exec(o), a = r[1];
                            return {val: a}
                        }
                    }
                    return !0
                ...
                for (var o = [["scale", ".01"], ["translateX", "20px"], ["translateY", "20px"], ["translateZ", "20px"], ["rotateX", "90deg"], ["rotateY", "90deg"], ["rotateZ", "180deg"]], r = 0; r < o.length; r++) {
                    var a = o[r][0], l = o[r][1], h = n && "scale" !== a;
                    e[t] += i(a) ? a + "(" + s(i(a, !0).val || l, h) + ") " : ""
                }
            };
        ...
        _goMix: function (t) {
            var e = this, i = function () {
                e._chrome && 31 === e._chrome && o(e._$parent[0]), e._setInter(), s()
            }, s = function () {
                var t = window.pageYOffset, i = window.pageXOffset;
                document.documentElement.scrollHeight;
                e._getInterMixData(), e._setFinal(), e._getFinalMixData(), window.pageYOffset !== t && window.scrollTo(i, t), e._prepTargets(), window.requestAnimationFrame ? requestAnimationFrame(n) : setTimeout(function () {
                    n()
                }, 20)
            }, n = function () {
                e._animateTargets(), 0 === e._targetsBound && e._cleanUp()
            }, o = function (t) {
                var e = t.parentElement, i = document.createElement("div"), s = document.createDocumentFragment();
        ...
        _getTargetData: function (t, e) {
            var i, s = this;
            t.dataset[e + "PosX"] = t.offsetLeft, t.dataset[e + "PosY"] = t.offsetTop, s.animation.animateResizeTargets && (i = s._suckMode ? {
                marginBottom: "",
                marginRight: ""
        ...
        _getOrigMixData: function () {
            ...
            for (var s = 0; s < t._$pre.length; s++) {
                var n = t._$pre[s];
        ...
        _prepTargets: function () {
            ...
            for (var s = 0; s < e._$toShow.length; s++) {
                var n = e._$toShow[s], o = t(n);
            ...
            for (var s = 0; s < e._$pre.length; s++) {
                var n = e._$pre[s], o = t(n),
                    r = {x: n.dataset.origPosX - n.dataset.interPosX, y: n.dataset.origPosY - n.dataset.interPosY},
                    i = e._getPrefixedCSS("transform", "translate(" + r.x + "px," + r.y + "px)");
        ...
        _animateTargets: function () {
            ...
            for (var i = 0; i < e._$toShow.length; i++) {
                var s = e._$toShow[i], n = t(s),
                    o = {x: s.dataset.finalPosX - s.dataset.interPosX, y: s.dataset.finalPosY - s.dataset.interPosY},
                    r = e._getDelay(i), a = {};
                s.style.opacity = "";
                for (var l = 0; 2 > l; l++) {
                    var h = 0 === l ? h = e._prefix : "";
                    e._ff && e._ff <= 20 && (a[h + "transition-property"] = "all", a[h + "transition-timing-function"] = e.animation.easing + "ms", a[h + "transition-duration"] = e.animation.duration + "ms"), a[h + "transition-delay"] = r + "ms", a[h + "transform"] = "translate(" + o.x + "px," + o.y + "px)"
                }
                (e.effects.transform || e.effects.opacity) && e._bindTargetDone(n), e._ff && e._ff <= 20 ? n.css(a) : n.css(e.effects.transition).css(a)
            }
            for (var i = 0; i < e._$pre.length; i++) {
                var s = e._$pre[i], n = t(s),
                    o = {x: s.dataset.finalPosX - s.dataset.interPosX, y: s.dataset.finalPosY - s.dataset.interPosY},
                    r = e._getDelay(i);
                (s.dataset.finalPosX !== s.dataset.origPosX || s.dataset.finalPosY !== s.dataset.origPosY) && e._bindTargetDone(n), n.css(e._getPrefixedCSS("transition", "all " + e.animation.duration + "ms " + e.animation.easing + " " + r + "ms")), n.css(e._getPrefixedCSS("transform", "translate(" + o.x + "px," + o.y + "px)")), e.animation.animateResizeTargets && (s.dataset.origWidth - s.dataset.finalWidth && 1 * s.dataset.finalWidth && (s.style.width = s.dataset.finalWidth + "px", s.style.marginRight = -(s.dataset.finalWidth - s.dataset.interWidth) + 1 * s.dataset.finalMarginRight + "px"), s.dataset.origHeight - s.dataset.finalHeight && 1 * s.dataset.finalHeight && (s.style.height = s.dataset.finalHeight + "px", s.style.marginBottom = -(s.dataset.finalHeight - s.dataset.interHeight) + 1 * s.dataset.finalMarginBottom + "px"))
            }
            e._changingClass && e._$container.removeClass(e.layout.containerClass).addClass(e._newClass);
            for (var i = 0; i < e._$toHide.length; i++) {
                for (var s = e._$toHide[i], n = t(s), r = e._getDelay(i), c = {}, l = 0; 2 > l; l++) {
                    var h = 0 === l ? h = e._prefix : "";
                    c[h + "transition-delay"] = r + "ms", c[h + "transform"] = e.effects.transformOut, c.opacity = e.effects.opacity
                }
        ...
        _bindTargetDone: function (e) {
            var i = this, s = e[0];
            i._execAction("_bindTargetDone", 0, arguments), s.dataset.bound || (s.dataset.bound = !0, i._targetsBound++, e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function (n) {
                (n.originalEvent.propertyName.indexOf("transform") > -1 || n.originalEvent.propertyName.indexOf("opacity") > -1) && t(n.originalEvent.target).is(i.selectors.target) && (e.off(".mixItUp"), s.dataset.bound = "", i._targetDone())
        ...
        _getPrefixedCSS: function (t, e, i) {
            var s = this, n = {}, o = "", r = -1;
            for (r = 0; 2 > r; r++) o = 0 === r ? s._prefix : "", i ? n[o + t] = o + e : n[o + t] = e;
            return s._execFilter("_getPrefixedCSS", n, arguments)
        },
        _getDelay: function (t) {
            var e = this,
                ...
                s = e.animation.stagger ? i * e.animation.staggerDuration : 0;
            return e._execFilter("_getDelay", s, arguments)
        },
        ...
        _parseInsertArgs: function (e) {
            for (var i = this, s = {
                index: 0,
                $object: t(),
                multiMix: {filter: i._state.activeFilter},
                callback: null
            }, n = 0; n < e.length; n++) {
                var o = e[n];
                "number" == typeof o ? s.index = o : "object" == typeof o && o instanceof t ? s.$object = o : "object" == typeof o && i._helpers._isElement(o) ? s.$object = t(o) : "object" == typeof o && null !== o ? s.multiMix = o : "boolean" != typeof o || o ? "function" == typeof o && (s.callback = o) : s.multiMix = !1
            }
            return i._execFilter("_parseInsertArgs", s, arguments)
        },
        _execAction: function (t, e, i) {
            var s = this, n = e ? "post" : "pre";
            if (!s._actions.isEmptyObject && s._actions.hasOwnProperty(t)) for (var o in s._actions[t][n]) s._actions[t][n][o].call(s, i)
        },
        _execFilter: function (t, e, i) {
            var s = this;
            if (s._filters.isEmptyObject || !s._filters.hasOwnProperty(t)) return e;
            for (var n in s._filters[t]) return s._filters[t][n].call(s, i)
        },
        _helpers: {
        ...
        getOption: function (t) {
            var i = this, s = function (t, i) {
                for (var s = i.split("."), n = s.pop(), o = s.length, r = 1, a = s[0] || i; (t = t[a]) && o > r;) a = s[r], r++;
                return t !== e ? t[n] !== e ? t[n] : t : void 0
            };
            return t ? i._execFilter("getOption", s(i, t), arguments) : i
        },
        ...
        destroy: function (e) {
            ...
            i._execAction("destroy", 1, arguments), s[i.selectors.filter] && s[i.selectors.filter] > 1 ? s[i.selectors.filter]-- : 1 === s[i.selectors.filter] && delete s[i.selectors.filter], n[i.selectors.sort] && n[i.selectors.sort] > 1 ? n[i.selectors.sort]-- : 1 === n[i.selectors.sort] && delete n[i.selectors.sort], delete t.MixItUp.prototype._instances[i._id]
        }
    }, t.fn.mixItUp = function () {
        var i, s = arguments, n = [], o = function (e, i) {
            var s = new t.MixItUp, n = function () {
                return ("00000" + (16777216 * Math.random() << 0).toString(16)).substr(-6).toUpperCase()
            };
            s._execAction("_instantiate", 0, arguments), e.id = e.id ? e.id : "MixItUp" + n(), s._instances[e.id] || (s._instances[e.id] = s, s._init(e, i)), s._execAction("_instantiate", 1, arguments)
        };
        return i = this.each(function () {
            if (s && "string" == typeof s[0]) {
                var i = t.MixItUp.prototype._instances[this.id];
                if ("isLoaded" === s[0]) n.push(i ? !0 : !1); else {
                    var r = i[s[0]](s[1], s[2], s[3]);
                    r !== e && n.push(r)
                }
            } else o(this, s[0])
        }), n.length ? n.length > 1 ? n : n[0] : i
    }, t.fn.removeStyle = function (i, s) {
        return s = s ? s : "", this.each(function () {
            for (var n = this, o = i.split(" "), r = 0; r < o.length; r++) for (var a = 0; 4 > a; a++) {
                switch (a) {
                    case 0:
                        var l = o[r];
                        break;
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        var l = t.MixItUp.prototype._helpers._camelCase(s + o[r])
                }
                if (n.style[l] !== e && "unknown" != typeof n.style[l] && n.style[l].length > 0 && (n.style[l] = ""), !s && 1 === a) break
            }
    ...
    function n(e, i) {
        this.settings = null, this.options = t.extend({}, n.Defaults, i), this.$element = t(e), this.drag = t.extend({}, g), this.state = t.extend({}, d),
            this.e = t.extend({}, u), this._plugins = {}, this._supress = {}, this._current = null, this._speed = null, this._coordinates = [], this._breakpoint = null, this._width = null, this._items = [], this._clones = [], this._mergers = [], this._invalidated = {}, this._pipe = [], t.each(n.Plugins, t.proxy(function (t, e) {
    ...
    g = {
        ...
        updatedX: 0,
        targetEl: null
    }, d = {isTouch: !1, isScrolling: !1, isSwiping: !1, direction: !1, inMotion: !1}, u = {
        _onDragStart: null,
        _onDragMove: null,
        _onDragEnd: null,
        _transitionEnd: null,
        ...
        var i, n, r, a, l, h;
        this.state.isTouch && (this.state.isScrolling || (i = t.originalEvent || t || e.event, n = o(i).x, r = o(i).y, this.drag.currentX = n - this.drag.startX, this.drag.currentY = r - this.drag.startY, this.drag.distance = this.drag.currentX - this.drag.offsetX, this.drag.distance < 0 ? this.state.direction = this.settings.rtl ? "right" : "left" : this.drag.distance > 0 && (this.state.direction = this.settings.rtl ? "left" : "right"), this.settings.loop ? this.op(this.drag.currentX, ">", this.coordinates(this.minimum())) && "right" === this.state.direction ? this.drag.currentX -= (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length) : this.op(this.drag.currentX, "<", this.coordinates(this.maximum())) && "left" === this.state.direction && (this.drag.currentX += (this.settings.center && this.coordinates(0)) - this.coordinates(this._items.length)) : (a = this.settings.rtl ? this.coordinates(this.maximum()) : this.coordinates(this.minimum()), l = this.settings.rtl ? this.coordinates(this.minimum()) : this.coordinates(this.maximum()), h = this.settings.pullDrag ? this.drag.distance / 5 : 0, this.drag.currentX = Math.max(Math.min(this.drag.currentX, a + h), l + h)), (this.drag.distance > 8 || this.drag.distance < -8) && (i.preventDefault !== s ? i.preventDefault() : i.returnValue = !1, this.state.isSwiping = !0), this.drag.updatedX = this.drag.currentX, (this.drag.currentY > 16 || this.drag.currentY < -16) && this.state.isSwiping === !1 && (this.state.isScrolling = !0, this.drag.updatedX = this.drag.start), this.animate(this.drag.updatedX)))
        ...
        if (this.settings.loop) {
            var n = i - this.relative(this.current()), o = this.current(), r = this.current(), a = this.current() + n,
                l = 0 > r - a ? !0 : !1, h = this._clones.length + this._items.length;
    ...
    n.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, n.prototype.fetch = function (t, e) {
        ...
        var s, n, o, r = i.width && i.height ? 'style="width:' + i.width + "px;height:" + i.height + 'px;"' : "",
            a = e.find("img"), l = "src", h = "", c = this._core.settings, p = function (t) {
        ...
        return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", h = "owl-lazy"), a.length ? (p(a.attr(l)), a.remove(), !1) : void ("youtube" === i.type ? (o = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg", p(o)) : "vimeo" === i.type && t.ajax({
            type: "GET",
        ...
        var i, s, n = t(e.target || e.srcElement), o = n.closest("." + this._core.settings.itemClass),
            r = this._videos[o.attr("data-video")], a = r.width || "100%", l = r.height || this._core.$stage.height();
    ...
    var t = function (t, e) {
        ...
        var i, s = Array.prototype.slice.call(arguments, 2), n = [], o = t.length;
        if (Array.prototype.map && t.map === Array.prototype.map) n = Array.prototype.map.call(t, function (t) {
            return callback_params = s, callback_params.splice(0, 0, t), e.apply(this, callback_params)
        }); else for (i = 0; o > i; i++) callback_params = s, callback_params.splice(0, 0, t[i]), n.push(e.apply(this, callback_params));
        return n
    }, s = function (t) {
        var e, i = [];
        ...
        var i = t[0], s = t[1];
        return e && (i = t[1], s = t[0]), new google.maps.LatLng(i, s)
    }, o = function (t, e) {
        var i;
        for (i = 0; i < t.length; i++) t[i] instanceof google.maps.LatLng || (t[i].length > 0 && "object" == typeof t[i][0] ? t[i] = o(t[i], e) : t[i] = n(t[i], e));
        return t
    }, r = function (t, e) {
        var i, t = t.replace("#", "");
        ...
        var e = 0, i = 0;
        if (t.offsetParent) do e += t.offsetLeft, i += t.offsetTop; while (t = t.offsetParent);
        return [e, i]
    }, l = function (e) {
        "use strict";
        var i = document, s = function (e) {
            ...
            var n, o = this,
                ...
                p = e.el || e.div, g = e.markerClusterer, d = google.maps.MapTypeId[e.mapType.toUpperCase()],
                u = new google.maps.LatLng(e.lat, e.lng), f = e.zoomControl || !0,
                m = e.zoomControlOpt || {style: "DEFAULT", position: "TOP_LEFT"}, _ = m.style || "DEFAULT",
                y = m.position || "TOP_LEFT", v = e.panControl || !0, w = e.mapTypeControl || !0,
                x = e.scaleControl || !0, b = e.streetViewControl || !0, C = C || !0, k = {},
                M = {zoom: this.zoom, center: u, mapTypeId: d}, $ = {
                    panControl: v,
                    zoomControl: f,
                    zoomControlOptions: {style: google.maps.ZoomControlStyle[_], position: google.maps.ControlPosition[y]},
                    mapTypeControl: w,
                    scaleControl: x,
                    streetViewControl: b,
                    overviewMapControl: C
                };
            if ("string" == typeof e.el || "string" == typeof e.div ? this.el = r(p, e.context) : this.el = p, "undefined" == typeof this.el || null === this.el) throw"No element defined.";
            ...
            for (1 != e.disableDefaultUI && (M = t(M, $)), k = t(M, e), n = 0; n < l.length; n++) delete k[l[n]];
            for (n = 0; n < h.length; n++) delete k[h[n]];
            this.map = new google.maps.Map(this.el, k), g && (this.markerClusterer = g.apply(this, [this.map]));
            var S = function (t, e) {
                var i = "", s = window.context_menu[o.el.id][t];
                for (var n in s) if (s.hasOwnProperty(n)) {
                    var l = s[n];
                    i += '<li><a id="' + t + "_" + n + '" href="#">' + l.title + "</a></li>"
                }
                if (r("gmaps_context_menu")) {
                    var h = r("gmaps_context_menu");
                    h.innerHTML = i;
                    var n, c = h.getElementsByTagName("a"), p = c.length;
                    for (n = 0; p > n; n++) {
                        var g = c[n], d = function (i) {
                            i.preventDefault(), s[this.id.replace(t + "_", "")].action.apply(o, [e]), o.hideContextMenu()
                        };
                        google.maps.event.clearListeners(g, "click"), google.maps.event.addDomListenerOnce(g, "click", d, !1)
                    }
                    var u = a.apply(this, [o.el]), f = u[0] + e.pixel.x - 15, m = u[1] + e.pixel.y - 15;
                    h.style.left = f + "px", h.style.top = m + "px", h.style.display = "block"
                }
            };
            this.buildContextMenu = function (t, e) {
                if ("marker" === t) {
                    ...
                    i.setMap(o.map), i.draw = function () {
                        var s = i.getProjection(), n = e.marker.getPosition();
                        e.pixel = s.fromLatLngToContainerPixel(n), S(t, e)
                    }
                } else S(t, e)
            }, this.setContextMenu = function (t) {
                window.context_menu[o.el.id][t.control] = {};
                var e, s = i.createElement("ul");
                for (e in t.options) if (t.options.hasOwnProperty(e)) {
                    var n = t.options[e];
                    window.context_menu[o.el.id][t.control][n.name] = {title: n.title, action: n.action}
                }
                s.id = "gmaps_context_menu", s.style.display = "none", s.style.position = "absolute", s.style.minWidth = "100px", s.style.background = "white", s.style.listStyle = "none", s.style.padding = "8px", s.style.boxShadow = "2px 2px 6px #ccc", i.body.appendChild(s);
            ...
            var L = function (t, i) {
                google.maps.event.addListener(t, i, function (t) {
                    void 0 == t && (t = this), e[i].apply(this, [t]), o.hideContextMenu()
                })
            };
            ...
            var T, A = [];
            for (T in this.map) "function" != typeof this.map[T] || this[T] || A.push(T);
            for (n = 0; n < A.length; n++) !function (t, e, i) {
                t[i] = function () {
    ...
    l.prototype.createControl = function (t) {
        ...
        for (var s in t.events) !function (e, i) {
        ...
        var i = this, s = e.details, n = e.fences, o = e.outside,
        ...
        for (var p = ["animation_changed", "clickable_changed", "cursor_changed", "draggable_changed", "flat_changed", "icon_changed", "position_changed", "shadow_changed", "shape_changed", "title_changed", "visible_changed", "zindex_changed"], g = ["dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"], c = 0; c < p.length; c++) !function (t, i) {
            e[i] && google.maps.event.addListener(t, i, function () {
                e[i].apply(this, [this])
            })
        }(l, p[c]);
        for (var c = 0; c < g.length; c++) !function (t, i, s) {
        ...
        return google.maps.event.addListener(l, "click", function () {
            this.details = s, e.click && e.click.apply(this, [this]), l.infoWindow && (i.hideInfoWindows(), l.infoWindow.open(i.map, l))
        ...
        if ("undefined" == typeof t) {
            for (var i = 0; i < this.markers.length; i++) {
                ...
                s.setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(s), l.fire("marker_removed", s, this)
            }
            this.markers = e
        } else {
        ...
        return e.setMap(this.map), null != t.auto_show && (i = t.auto_show), e.onAdd = function () {
            ...
            var s = this.getPanes(), n = s[t.layer], o = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            n.appendChild(i);
            ...
            t.click && (s.overlayMouseTarget.appendChild(e.el), google.maps.event.addDomListener(e.el, "click", function () {
                t.click.apply(e, [e])
            })), google.maps.event.trigger(this, "ready")
        }, e.draw = function () {
            var s = this.getProjection(), n = s.fromLatLngToDivPixel(new google.maps.LatLng(t.lat, t.lng));
            t.horizontalOffset = t.horizontalOffset || 0, t.verticalOffset = t.verticalOffset || 0;
            var o = e.el, r = o.children[0], a = r.clientHeight, l = r.clientWidth;
            switch (t.verticalAlign) {
                case"top":
                    o.style.top = n.y - a + t.verticalOffset + "px";
                    break;
                default:
                case"middle":
                    o.style.top = n.y - a / 2 + t.verticalOffset + "px";
                    break;
                case"bottom":
            ...
            switch (t.horizontalAlign) {
                case"left":
                    o.style.left = n.x - l + t.horizontalOffset + "px";
                    break;
                default:
                case"center":
                    o.style.left = n.x - l / 2 + t.horizontalOffset + "px";
                    break;
                case"right":
        ...
        var e = [], i = t.path;
        if (i.length) if (void 0 === i[0][0]) e = i; else for (var s, n = 0; s = i[n]; n++) e.push(new google.maps.LatLng(s[0], s[1]));
        var o = {
            map: this.map,
            path: e,
        ...
        for (var r = new google.maps.Polyline(o), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], h = 0; h < a.length; h++) !function (e, i) {
        ...
        for (var i = new google.maps.Circle(e), s = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], n = 0; n < s.length; n++) !function (t, i) {
        ...
        e.bounds = i;
        for (var s = new google.maps.Rectangle(e), n = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], o = 0; o < n.length; o++) !function (t, i) {
            e[i] && google.maps.event.addListener(t, i, function (t) {
                e[i].apply(this, [t])
            })
        }(s, n[o]);
        return this.polygons.push(s), s
    }, l.prototype.drawPolygon = function (e) {
        var n = !1;
        e.hasOwnProperty("useGeoJSON") && (n = e.useGeoJSON), delete e.useGeoJSON, e = t({map: this.map}, e), 0 == n && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = s(i(e.paths, o, n)));
        for (var r = new google.maps.Polygon(e), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], h = 0; h < a.length; h++) !function (t, i) {
            e[i] && google.maps.event.addListener(t, i, function (t) {
                e[i].apply(this, [t])
            })
        }(r, a[h]);
        ...
        var s = t, n = new google.maps.KmlLayer(e, s);
    ...
    return l.prototype.getRoutes = function (e) {
        switch (e.travelMode) {
            case"bicycling":
                h = google.maps.TravelMode.BICYCLING;
                break;
            case"transit":
                h = google.maps.TravelMode.TRANSIT;
                break;
            case"driving":
                h = google.maps.TravelMode.DRIVING;
                break;
            default:
                h = google.maps.TravelMode.WALKING
        }
        c = "imperial" === e.unitSystem ? google.maps.UnitSystem.IMPERIAL : google.maps.UnitSystem.METRIC;
        var i = {avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: []}, s = t(i, e);
        s.origin = /string/.test(typeof e.origin) ? e.origin : new google.maps.LatLng(e.origin[0], e.origin[1]), s.destination = /string/.test(typeof e.destination) ? e.destination : new google.maps.LatLng(e.destination[0], e.destination[1]), s.travelMode = h, s.unitSystem = c, delete s.callback, delete s.error;
        var n = this, o = new google.maps.DirectionsService;
        o.route(s, function (t, i) {
            if (i === google.maps.DirectionsStatus.OK) {
                for (var s in t.routes) t.routes.hasOwnProperty(s) && n.routes.push(t.routes[s]);
                e.callback && e.callback(n.routes)
        ...
        e = t({
            ...
            path: !1,
            samples: 256
        }, e), e.locations.length > 0 && e.locations[0].length > 0 && (e.locations = s(i([e.locations], o, !1)));
        var n = e.callback;
        delete e.callback;
        ...
        if (t.origin && t.destination) this.getRoutes({
            ...
            callback: function (e) {
                if (e.length > 0 && t.start && t.start(e[e.length - 1]), e.length > 0 && t.step) {
                    var i = e[e.length - 1];
                    if (i.legs.length > 0) for (var s, n = i.legs[0].steps, o = 0; s = n[o]; o++) s.step_number = o, t.step(s, i.legs[0].steps.length - 1)
                }
        ...
        if (t.origin && t.destination) this.getRoutes({
            ...
            callback: function (i) {
                if (i.length > 0 && t.start && t.start(i[i.length - 1]), i.length > 0 && t.step) {
                    var s = i[i.length - 1];
                    if (s.legs.length > 0) for (var n, o = s.legs[0].steps, r = 0; n = o[r]; r++) {
                        n.step_number = r;
                        var a = {
                            path: n.path,
                            strokeColor: t.strokeColor,
                        ...
                        t.hasOwnProperty("icons") && (a.icons = t.icons), e.drawPolyline(a), t.step(n, s.legs[0].steps.length - 1)
                    }
                }
                i.length > 0 && t.end && t.end(i[i.length - 1])
            }
        }); else if (t.route && t.route.legs.length > 0) for (var i, s = t.route.legs[0].steps, n = 0; i = s[n]; n++) {
            i.step_number = n;
            var o = {
                path: i.path,
                strokeColor: t.strokeColor,
        ...
        if (t.fences) for (var i, s = 0; i = t.fences[s]; s++) {
            var n = t.getPosition();
            this.checkGeofence(n.lat(), n.lng(), i) || e(t, i)
        }
        ...
        delete t.styles;
        var a = t.polyline;
        if (delete t.polyline, t.center) s.push("center=" + t.center), delete t.center; else if (t.address) s.push("center=" + t.address), delete t.address; else if (t.lat) s.push(["center=", t.lat, ",", t.lng].join("")), delete t.lat, delete t.lng; else if (t.visible) {
            var l = encodeURI(t.visible.join("|"));
            s.push("visible=" + l)
        }
        var h = t.size;
        h ? (h.join && (h = h.join("x")), delete t.size) : h = "630x300", s.push("size=" + h), t.zoom || t.zoom === !1 || (t.zoom = 15);
        var c = t.hasOwnProperty("sensor") ? !!t.sensor : !0;
        delete t.sensor, s.push("sensor=" + c);
        for (var p in t) t.hasOwnProperty(p) && s.push(p + "=" + t[p]);
        if (o) for (var g, d, u = 0; i = o[u]; u++) {
            g = [], i.size && "normal" !== i.size ? (g.push("size:" + i.size), delete i.size) : i.icon && (g.push("icon:" + encodeURI(i.icon)), delete i.icon), i.color && (g.push("color:" + i.color.replace("#", "0x")), delete i.color), i.label && (g.push("label:" + i.label[0].toUpperCase()), delete i.label), d = i.address ? i.address : i.lat + "," + i.lng, delete i.address, delete i.lat, delete i.lng;
            for (var p in i) i.hasOwnProperty(p) && g.push(p + ":" + i[p]);
            g.length || 0 === u ? (g.push(d), g = g.join("|"), s.push("markers=" + encodeURI(g))) : (g = s.pop() + encodeURI("|" + d), s.push(g))
        }
        if (r) for (var u = 0; u < r.length; u++) {
            var f = [];
            r[u].featureType && f.push("feature:" + r[u].featureType.toLowerCase()), r[u].elementType && f.push("element:" + r[u].elementType.toLowerCase());
            for (var m = 0; m < r[u].stylers.length; m++) for (var _ in r[u].stylers[m]) {
                var y = r[u].stylers[m][_];
                ("hue" == _ || "color" == _) && (y = "0x" + y.substring(1)), f.push(_ + ":" + y)
            }
            var v = f.join("|");
            "" != v && s.push("style=" + v)
        }
        if (a) {
            if (i = a, a = [], i.strokeWeight && a.push("weight:" + parseInt(i.strokeWeight, 10)), i.strokeColor) {
                var w = e(i.strokeColor, i.strokeOpacity);
                a.push("color:" + w)
            }
            if (i.fillColor) {
            ...
            var b = i.path;
            if (b.join) for (var C, m = 0; C = b[m]; m++) a.push(C.join(",")); else a.push("enc:" + b);
            a = a.join("|"), s.push("path=" + encodeURI(a))
        }
        var k = window.devicePixelRatio || 1;
        return s.push("scale=" + k), s = s.join("&"), n + s
        ...
        var i = r(e.el, e.context);
        e.position = new google.maps.LatLng(e.lat, e.lng), delete e.el, delete e.context, delete e.lat, delete e.lng;
        for (var s = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], n = t({visible: !0}, e), o = 0; o < s.length; o++) delete n[s[o]];
        for (var a = new google.maps.StreetViewPanorama(i, n), o = 0; o < s.length; o++) !function (t, i) {
            e[i] && google.maps.event.addListener(t, i, function () {
                e[i].apply(this)
            })
        }(a, s[o]);
        ...
        if (-1 == l.custom_events.indexOf(t)) return e instanceof l && (e = e.map), google.maps.event.addListener(e, t, i);
        ...
        if (-1 == l.custom_events.indexOf(t)) google.maps.event.trigger(e, t, Array.prototype.slice.apply(arguments).slice(2)); else if (t in i.registered_events) for (var s = i.registered_events[t], n = 0; n < s.length; n++) !function (t, e, i) {
            t.apply(e, [i])
        }(s[n].handler, i, e)
        ...
        for (var e, i = new google.maps.LatLngBounds, s = this.getPaths(), n = 0; n < s.getLength(); n++) {
            e = s.getAt(n);
        ...
        for (var i = !1, s = this.getPaths().getLength(), n = 0; s > n; n++) for (var o = this.getPaths().getAt(n), r = o.getLength(), a = r - 1, l = 0; r > l; l++) {
            var h = o.getAt(l), c = o.getAt(a);
        ...
        if (0 === i) return -1;
        var s = 0;
        if (arguments.length > 1 && (s = Number(arguments[1]), s != s ? s = 0 : 0 != s && s != 1 / 0 && s != -(1 / 0) && (s = (s > 0 || -1) * Math.floor(Math.abs(s)))), s >= i) return -1;
